            ...
            <div class="col-12">
                <div class="title-heading st-3">
                    <div class="sub-heading clr-pri-3 f-mulish">
                        ...
                        <span class="inner-sub st-1">Testimoni</span>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="77" height="30" viewBox="0 0 77 30">
                            <g>
                    ...
                    <h2 class="title clr-pri-2">Apa yang mereka katakan mengenai <span class="clr-pri-3">Syameela</span> Kids</h2>
                </div>
            </div>
                        ...
                        <div class="owl-carousel owl-theme none">
                            ...
                            <!-- <div data-dot="" class="item-fb wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1300ms">
                                <div class="heading fx">
                                    ...
                                    <ul>
                                        <li><h4 class="name-author clr-pri-2">Bradley G. Grimes</h4></li>
                            ...
                            <div data-dot="" class="item-fb wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1300ms">
                                <div class="heading fx">
                                    ...
                                    <ul>
                                        <li><h4 class="name-author clr-pri-2">Bradley X. Grimes</h4></li>
                                        <li><p class="clr-pri-5 f-mulish">Orang tua dari Mahardika</p></li>
                                    </ul>
                                </div>
                                <div class="wrap">
